...
@Component({
  ...
  templateUrl: "./settting-popup.component.html",
  styleUrls: ["./settting-popup.component.scss"],
})
export class SetttingPopupComponent {
  settingsdata: any;
  ...
  showSystem = false;
  constructor(
    public dialogRef: MatDialogRef<SetttingPopupComponent>,
