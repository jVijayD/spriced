...
public class IsNotNull  extends BaseSpecification {

	protected IsNotNull(String column, Object value, ConditionType conditionType, OperandType operandType, ConditionType subConditionType) {
