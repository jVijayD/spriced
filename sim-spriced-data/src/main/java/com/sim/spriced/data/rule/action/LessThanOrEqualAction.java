...
public class LessThanOrEqualAction extends BaseAction implements IAction<JSONObject> {
	...
	public LessThanOrEqualAction(Object operand, String column, String actionGroup) {
	...
	public String getName() {
		return Action.ActionType.MUST_BE_LESS_THAN_EQUAL.toString();
	}
