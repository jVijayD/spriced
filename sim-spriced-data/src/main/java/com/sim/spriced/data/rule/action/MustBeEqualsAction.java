...
public class MustBeEqualsAction extends BaseAction implements IAction<JSONObject> {
	...
	public MustBeEqualsAction(Object operand, String column, String actionGroup) {
	...
	public String getName() {
		return Action.ActionType.MUST_BE_EQUAL_TO.toString();
	}
