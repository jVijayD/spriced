...
public class GreaterThanAction extends BaseAction implements IAction<JSONObject> {
	...
	public GreaterThanAction(Object operand, String column, String actionGroup) {
	...
	public String getName() {
		return Action.ActionType.MUST_BE_GREATER_THAN.toString();
	}
