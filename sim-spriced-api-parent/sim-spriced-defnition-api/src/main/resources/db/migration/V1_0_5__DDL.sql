...
-- Table: public.roleentitypermissionmapping

-- DROP TABLE IF EXISTS public.roleentitypermissionmapping;

CREATE TABLE IF NOT EXISTS public.roleentitypermissionmapping
(
...
ALTER TABLE IF EXISTS public.roleentitypermissionmapping
    OWNER to postgres;
	
	
	
-- Table: public.rolegrouppermissionmapping

-- DROP TABLE IF EXISTS public.rolegrouppermissionmapping;

CREATE TABLE IF NOT EXISTS public.rolegrouppermissionmapping
(
    id bigint NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    role character varying(25) COLLATE pg_catalog."default" NOT NULL,
...
ALTER TABLE IF EXISTS public.rolegrouppermissionmapping
    OWNER to postgres;