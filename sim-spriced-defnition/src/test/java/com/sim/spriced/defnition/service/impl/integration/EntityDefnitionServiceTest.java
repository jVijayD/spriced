...
//		attributes.add(new Attribute("col3",Type.FREE_FORM,DataType.BOOLEAN));
//		attributes.add(new Attribute("col4",Type.FREE_FORM,DataType.CHARACTER));
//		attributes.add(new Attribute("col5",Type.FREE_FORM,DataType.BOOLEAN,ChangeType.UPDATE));
//		attributes.add(new Attribute("col7",Type.FREE_FORM,DataType.INTEGER,ChangeType.DELETE));
//
//	
//		attributes.add(varString);
//		
